...
// 每个分类的默认装备模板
const DEFAULT_ITEMS: Record<string, { name: string; notes: string; quantity: number }[]> = {
  '背负系统': [
    { name: '大背包 (50-70L)', notes: '轻量化优先，带防雨罩', quantity: 1 },
    { name: '冲顶包/腰包 (15-25L)', notes: '放随身贵重物品', quantity: 1 },
    { name: '防水袋/压缩袋', notes: '保护衣物和电子设备', quantity: 3 },
  ],
  '睡眠系统': [
    { name: '帐篷', notes: '三季帐或四季帐，看季节', quantity: 1 },
    { name: '睡袋', notes: '温标比最低温再低5°C', quantity: 1 },
    { name: '防潮垫', notes: '充气垫舒适，蛋巢垫可靠', quantity: 1 },
    { name: '充气枕头', notes: '可选，提升睡眠质量', quantity: 1 },
    { name: '地布', notes: '保护帐篷底部', quantity: 1 },
  ],
  '饮食系统': [
    { name: '炉头', notes: '分体式更稳定，一体式更轻', quantity: 1 },
    { name: '气罐', notes: '高海拔用高山气罐', quantity: 2 },
    { name: '锅具套装', notes: '钛合金最轻，铝合金性价比高', quantity: 1 },
    { name: '餐具 (碗/筷/勺)', notes: '折叠或钛合金', quantity: 1 },
    { name: '水袋/水瓶 (2-3L)', notes: '软水袋省空间', quantity: 2 },
    { name: '净水器/净水片', notes: '野外取水必备', quantity: 1 },
    { name: '保温杯', notes: '冬季/高海拔推荐', quantity: 1 },
  ],
  '服装-上衣': [
    { name: '冲锋衣 (硬壳)', notes: 'Gore-Tex或类似防水透气', quantity: 1 },
    { name: '抓绒衣/棉服', notes: '保暖中层', quantity: 1 },
    { name: '速干T恤 (长袖)', notes: '美利奴羊毛或速干面料', quantity: 2 },
    { name: '羽绒服 (营地用)', notes: '充绒量200g+', quantity: 1 },
    { name: '保暖内衣', notes: '美利奴羊毛最佳', quantity: 1 },
  ],
  '服装-下装': [
    { name: '冲锋裤 (硬壳)', notes: '防风防水', quantity: 1 },
    { name: '速干裤', notes: '日常徒步穿', quantity: 1 },
    { name: '雨衣 (分体式)', notes: '比雨披更方便', quantity: 1 },
  ],
  '鞋袜': [
    { name: '徒步鞋 (高帮防水)', notes: '提前磨合2周以上！', quantity: 1 },
    { name: '徒步袜 (羊毛)', notes: '美利奴羊毛，防磨防臭', quantity: 3 },
    { name: '营地鞋/溯溪鞋', notes: '轻便备用', quantity: 1 },
    { name: '雪套', notes: '雨雪泥地防护', quantity: 1 },
  ],
  '登山杖/冰爪': [
    { name: '登山杖 (双杖)', notes: '碳纤维最轻，铝合金耐用', quantity: 2 },
    { name: '冰爪', notes: '冰雪路面必备', quantity: 1 },
  ],
  '照明': [
    { name: '头灯', notes: '首选，解放双手', quantity: 1 },
    { name: '备用电池', notes: 'AA或18650，看头灯型号', quantity: 2 },
  ],
  '电子设备': [
    { name: '充电宝 (20000mAh+)', notes: '至少够充手机2-3次', quantity: 2 },
    { name: '手机 + 离线地图', notes: '提前下载离线地图', quantity: 1 },
    { name: 'GPS手持机', notes: '可选，长线推荐', quantity: 1 },
    { name: '太阳能充电板', notes: '长线可选', quantity: 1 },
  ],
  '急救/药品': [
    { name: '急救包', notes: '创可贴/碘伏棉签/绷带/医用胶带', quantity: 1 },
    { name: '常用药品', notes: '止痛药/止泻药/过敏药/感冒药', quantity: 1 },
    { name: '抗高反药', notes: '乙酰唑胺/红景天，高海拔必备', quantity: 1 },
    { name: '防晒霜 (SPF50+)', notes: '高原紫外线强', quantity: 1 },
    { name: '防蚊液', notes: '夏季必备', quantity: 1 },
  ],
  '导航通讯': [
    { name: '地图 (纸质)', notes: '电子设备没电时的后备', quantity: 1 },
    { name: '指南针', notes: '小巧必备', quantity: 1 },
    { name: '卫星电话/SOS设备', notes: '无信号区域安全保障', quantity: 1 },
  ],
  '工具': [
    { name: '多功能刀/瑞士军刀', notes: '实用小工具', quantity: 1 },
    { name: '打火机/防水火柴', notes: '生火备用', quantity: 2 },
    { name: '修补工具', notes: '帐篷修补/睡垫修补片', quantity: 1 },
    { name: '登山绳/扁带', notes: '必要时使用', quantity: 1 },
    { name: '垃圾袋', notes: 'LNT原则，带走所有垃圾', quantity: 3 },
  ],
  '其他': [
    { name: '墨镜', notes: '高原/雪地防紫外线', quantity: 1 },
    { name: '速干毛巾', notes: '轻便快干', quantity: 1 },
    { name: '身份证/现金', notes: '山区可能无信号', quantity: 1 },
    { name: '纸巾/湿巾', notes: '个人卫生', quantity: 1 },
    { name: '户外保险', notes: '含直升机救援', quantity: 1 },
  ],
}
